                                ...
                                @if(Session::get('account_type')=='admin')
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="active"><a href="accounts">View Accounts</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)">
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    {{ Form::open(array('url' => '/accounts/edit/'.$data->id, 'method'=>'post','autocomplete' => 'off', 'role'=>'form', 'class'=>'form-horizontal')) }}
                                    {{ csrf_field() }}
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 control-label">Account Details I</label>
                                            <div class="col-sm-5">
                                                {{ Form::text('account_name',$data->account_name,array('placeholder'=>'Account Name','class'=>'form-control','id'=>'account_name','name'=>'account_name')) }}
                                            </div>
                                            <div class="col-sm-5">
                                                {{ Form::text('account_number',$data->account_number,array('placeholder'=>'Account Number','class'=>'form-control','id'=>'account_number','name'=>'account_number')) }}
                                            </div>
                                        </div>
                                        <div>&nbsp;</div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 control-label">Account Details II</label>
                                            <div class="col-sm-5">
                                                {{ Form::text('account_balance',$data->account_balance,array('placeholder'=>'Account Balance','class'=>'form-control','id'=>'account_balance','name'=>'account_balance')) }}
                                            </div>
                                            <div class="col-sm-5">
                                        ...
                                        <div>&nbsp;</div>
                                        <div class="col-sm-10">
                                            @if(Session::get('account_message'))
                                                <div class="alert alert-info" role="alert">{{Session::get('account_message')}}</div>
                                            @endif
                                        </div>
