                                   ...
                                   <div class="table-responsive">
                                    @if(!$data->isEmpty())
                                        <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                            <thead>
                                                <tr>
                                                    <th class="hidden-xs hidden-sm text-center" style="width: 60px;"><i class="si si-reorder"></i></th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="hidden-xs hidden-sm text-center">{{$account->id}}</td>
                                                    <td>{{$account->account_name}}</td>
                                                    <td class="font-w600">{{$account->account_number}}</td>
                                                    <td class="font-w600">{{$account->account_balance}}</td>
                                                    <td class="font-w600">{{$account->email}}</td>
                                                    <td class="hidden-xs">
                                                        ...
                                                        <span class="label label-warning">{{$account->status}}</span>
                                                        @endif
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <a href="account-{{$account->id}}"><button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="View Account"><i class="fa fa-eye"></i></button></a>
                                                            <a href="account-edit-{{$account->id}}"><button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit Account"><i class="fa fa-pencil"></i></button></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                @endforeach
