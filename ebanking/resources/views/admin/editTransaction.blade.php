                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    {{ Form::open(array('url' => '/transactions/edit/'.$data->id, 'method'=>'post','autocomplete' => 'off', 'role'=>'form', 'class'=>'form-horizontal')) }}
                                    {{ csrf_field() }}
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 control-label">Transaction Details I</label>
                                            <div class="col-sm-5">
                                                {{ Form::text('amount',$data->amount,array('placeholder'=>'Amount','class'=>'form-control','id'=>'amount','name'=>'amount')) }}
                                            </div>
                                            <div class="col-sm-5">
                                                {{ Form::text('description',$data->description,array('placeholder'=>'Description','class'=>'form-control','id'=>'description','name'=>'description')) }}
                                            </div>
                                        </div>
                                        <div>&nbsp;</div>
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 control-label">Transaction Details II</label>
                                            <div class="col-sm-10">
                                                {{ Form::text('charges',$data->charges,array('placeholder'=>'Charges','class'=>'form-control','id'=>'charges','name'=>'charges')) }}
                                            </div>
                                        </div>
                                        <div>&nbsp;</div>
                                        <div class="col-sm-10">
