                                ...
                                @if(Session::get('account_type')=='admin')
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu">
                                            ...
                                            <li class="active"><a href="users">View Users</a></li>
                                        </ul>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0)">
                                   ...
                                   <div class="table-responsive">
                                    @if(!$data->isEmpty())
                                        <table id="example" class="display table" style="width: 100%; cellspacing: 0;">
                                            <thead>
                                                <tr>
                                                    <th class="hidden-xs hidden-sm text-center" style="width: 60px;"><i class="si si-users"></i></th>
                                                    <th class="hidden-xs hidden-sm" style="width: 25%;">Name(L)</th>
                                                    <th class="hidden-xs hidden-sm" style="width: 25%;">Name(F)</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="hidden-xs hidden-sm text-center">{{$user->id}}</td>
                                                    <td class="hidden-xs hidden-sm font-w600">{{$user->last_name}}</td>
                                                    <td class="hidden-xs hidden-sm font-w600">{{$user->first_name}}</td>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            <a href="users-{{$user->id}}"><button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="View User"><i class="fa fa-eye"></i></button></a>
                                                            <a href="users-edit-{{$user->id}}"><button class="btn btn-xs btn-default" type="button" data-toggle="tooltip" title="Edit User"><i class="fa fa-pencil"></i></button></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                @endforeach
