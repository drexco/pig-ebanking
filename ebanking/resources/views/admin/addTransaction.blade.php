                            ...
                            @if(Session::get('user_id'))
                                @if(Session::get('account_type')=='admin')
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu">
                                            <li class="active"><a href="createtransaction">Create Transaction</a></li>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    {{ Form::open(array('url' => '/transactions/create', 'method'=>'post','role'=>'form', 'class'=>'form_horizontal')) }}
                                        <div class="form-group">
                                            <label for="tx_dets" class="col-sm-2 control-label">Transaction Details I</label>
                                            <div class="col-sm-5">
                                                <input type="number" class="form-control" id="amount" name="amount" placeholder="Transaction Amount">
                                            </div>
                                            <div class="col-sm-5">
                                        ...
                                        <div>&nbsp;</div>
                                        <div class="form-group">
                                            <label for="tx_dets_2" class="col-sm-2 control-label">Transaction Details II</label>
                                            <div class="col-sm-10">
                                                <input type="number" class="form-control" id="charges" name="charges" placeholder="Charges">
                                            </div>
                                        </div>
                                        <div>&nbsp;</div>
                                        <div class="form-group">
                                            <label for="user_det" class="col-sm-2 control-label">User/Account Detail</label>
                                            <div class="col-sm-5">
                                                <select class="form-control" id="user_id" name="user_id" style="width: 100%;" data-placeholder="Select User Email...">
                                                    <option value="0">Select User Email</option>
                                            ...
                                            <div class="col-sm-5">
                                                <select class="form-control" id="account_id" name="account_id" style="width: 100%;" data-placeholder="Select Account Number...">
                                        ...
                                        <div>&nbsp;</div>
                                        <div class="col-sm-10">
                                            @if(Session::get('tx_message'))
                                                <div class="alert alert-info" role="alert">{{Session::get('tx_message')}}</div>
                                            @endif
                                        </div>
