                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    {{ Form::open(array('url' => '/users/create', 'method'=>'post','role'=>'form', 'class'=>'form_horizontal')) }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <div style="margin-bottom:15px;" class="input-group">
                                                    ...
                                                    <input type="email" class="form-control" placeholder="Email" aria-describedby="basic-addon1" id="email" name="email">
                                                </div>
                                                <div style="margin-bottom:15px;" class="input-group">
                                                    <span class="input-group-addon" id="basic-addon1">#</span>
                                                    <input type="number" class="form-control" placeholder="Phone" aria-describedby="basic-addon1" id="phone_no" name="phone_no">
                                                </div>
                                                <div style="margin-bottom:15px;" class="input-group">
                                                    <input type="password" class="form-control" aria-describedby="basic-addon2" id="password" name="password" placeholder="Password">
