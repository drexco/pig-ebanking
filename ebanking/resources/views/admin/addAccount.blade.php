                        ...
                        <div class="col-md-12">
                            <div class="panel panel-white">
                                ...
                                <div class="panel-body">
                                    {{ Form::open(array('url' => '/accounts/create', 'method'=>'post','role'=>'form', 'class'=>'form_horizontal')) }}
                                        <div class="form-group">
                                            <label for="account_dets" class="col-sm-2 control-label">Account Details I</label>
                                            <div class="col-sm-5">
                                        ...
                                        <div>&nbsp;</div>
                                        <div class="form-group">
                                            <label for="account_dets_2" class="col-sm-2 control-label">Account Details II</label>
                                            <div class="col-sm-5">
                                                <select id="account_type" name="account_type" style="margin-bottom:15px;" class="form-control">
                                        ...
                                        <div>&nbsp;</div>
                                        <div class="form-group">
                                            <label for="user_det" class="col-sm-2 control-label">User Detail</label>
                                            <div class="col-sm-10">
